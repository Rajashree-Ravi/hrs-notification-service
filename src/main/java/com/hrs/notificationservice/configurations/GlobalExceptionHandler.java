...
public class GlobalExceptionHandler {
	 ...
	 * ResponseEntity<ApiErrorResponse> handleValidationErrors(final
	 ...
	 * ResponseEntity<ApiErrorResponse> handleCustomerNotFoundExceptions(final
	 * CustomerNotFoundException ex, final HttpServletRequest request) {
	 * 
	 * List<String> errors = Collections.singletonList(ex.getMessage());
	 * 
	 * ApiErrorResponse response = new
	 * ApiErrorResponse(HttpStatus.NOT_FOUND.value(), HttpStatus.NOT_FOUND.name(),
